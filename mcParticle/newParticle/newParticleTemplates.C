...
void Foam::newParticle::readFields(TrackCloudType& c)
{
    bool valid = c.size();
...
template<class TrackCloudType>
void Foam::newParticle::writeFields(const TrackCloudType& c)
{
    label np = c.size();
...
template<class TrackCloudType>
void Foam::newParticle::hitFaceNoChangeToMasterPatch
(
    const vector& displacement,
    const scalar fraction,
    TrackCloudType& cloud,
...
template<class TrackCloudType>
Foam::scalar Foam::newParticle::trackToAndHitFace
(
    const vector& displacement,
    const scalar fraction,
    TrackCloudType& cloud,
...
template<class TrackCloudType>
bool Foam::newParticle::hitPatch(TrackCloudType&, trackingData&)
{
    return false;
}
...
template<class TrackCloudType>
void Foam::newParticle::hitWedgePatch(TrackCloudType& cloud, trackingData& td)
{
...
template<class TrackCloudType>
void Foam::newParticle::hitSymmetryPlanePatch
(
    TrackCloudType& cloud,
    trackingData& td
)
...
template<class TrackCloudType>
void Foam::newParticle::hitSymmetryPatch(TrackCloudType&, trackingData&)
{
...
template<class TrackCloudType>
void Foam::newParticle::hitCyclicPatch(TrackCloudType&, trackingData&)
{
...
template<class TrackCloudType>
void Foam::newParticle::hitCyclicAMIPatch
(
    const vector& displacement,
    const scalar fraction,
    TrackCloudType& cloud,
...
)
{
    ...
    if (receiveFacei < 0)
    {
        ...
        WarningInFunction
            ...
            << "    The newParticle has been removed" << nl << endl;
        return;
    }
    ...
    // Locate the newParticle on the receiving side
    locate
    (
        pos,
    ...
    // The newParticle must remain associated with a face for the tracking to
    ...
    // then issue a warning and remove the newParticle
    if (onBoundaryFace())
    {
...
template<class TrackCloudType>
void Foam::newParticle::hitCyclicACMIPatch
(
    const vector& displacement,
    const scalar fraction,
    TrackCloudType& cloud,
...
template<class TrackCloudType>
void Foam::newParticle::hitCyclicRepeatAMIPatch
(
    const vector& displacement,
    const scalar fraction,
    TrackCloudType& cloud,
...
template<class TrackCloudType>
void Foam::newParticle::hitProcessorPatch(TrackCloudType&, trackingData&)
{}


template<class TrackCloudType>
void Foam::newParticle::hitWallPatch(TrackCloudType&, trackingData&)
{}
